                            ...
                            <tbody class="px-6 py-3 text-xs font-semibold text-left border-spacing-4">
                                ...
                                <tr>
                                    ...
                                    <td class="flex text-sm font-normal leading-normal border-t">
                                        <a href="{{ route('admin.outlet.edit', $d['id']) }}" class="mx-2"><i class="fas fa-edit fa-lg hover:scale-102"></i></a>
                                        <a class="mx-1 btn btn-danger btn-xs">
                                            <form action="{{ route('admin.outlet.delete', $d['id']) }}" method="post" onsubmit="return confirm('Apakah yakin ingin menghapus outlet {{ $d['nama'] }} ?')">
                                                @csrf
                                                @method('delete')
