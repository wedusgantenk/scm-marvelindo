            ...
            <div class="relative flex flex-col min-w-0 p-6 mb-6 break-words border-0 border-transparent border-solid bg-csite shadow-soft-xl rounded-2xl bg-clip-border">
                ...
                <div class="flex-auto ">
                    <form action="{{ route('admin.petugas.store') }}" method="POST" enctype="multipart/form-data" role="form">
                        ...
                        <div class="mb-4">
                            <input type="text" class="flex-auto focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-red-300 focus:outline-none focus:transition-shadow max-w-full min-w-12" id="username" placeholder="Masukkan nama petugas" aria-label="petugas" aria-describedby="petugas-addon" autocomplete="off" value="{{ old('username') }}" name="username" required>
                            @error('username')
                        ...
                        <div class="mb-4">
                            <input type="password" class="flex-auto focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-red-300 focus:outline-none focus:transition-shadow max-w-full min-w-12" id="password" placeholder="Masukkan password" aria-label="password" aria-describedby="password" autocomplete="off" value="{{ old('password') }}" name="password" required>
                            @error('password')
