            ...
            <div class="relative flex flex-col min-w-0 p-6 mb-6 break-words bg-white border-0 border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                ...
                <div class="flex-auto pb-2">
                    <div class="overflow-x-auto">
                        <table id="datatables" class="table max-w-full overflow-auto table-flush text-slate-800">
                            ...
                            <tbody class="px-6 py-3 text-xs font-semibold text-left border-spacing-4">
                                ...
                                <tr>
                                    ...
                                    <td class="text-sm font-normal leading-normal border-t"> {{ $d['alamat'] }} </td>
                                    <td class="flex text-sm font-normal leading-normal border-t">
                                        <a href="{{ route('admin.bts.edit', $d['id']) }}" class="mx-2 btn btn-success btn-xs"><i class="fas fa-edit fa-lg hover:scale-102"></i></a>
                                        <a class="mx-1 btn btn-danger btn-xs">
                                            <form action="{{ route('admin.bts.delete', $d['id']) }}" method="post" onsubmit="return confirm('Apakah yakin ingin menghapus bts {{ $d['nama'] }} ?')">
                                                @csrf
                                                @method('delete')
                                ...
                                @empty
                                <tr>
                                    <th colspan="4" class="p-2 text-center bg-transparent border-b whitespace-nowrap shadow-transparent">Tidak ada data</th>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
