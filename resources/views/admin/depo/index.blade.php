                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="flex space-x-2 text-sm font-normal leading-normal border-t">
                                        <a href="{{ route('admin.depo.edit', $d['id']) }}" class="mx-2 btn btn-success btn-xs"><i class="fas fa-edit fa-lg hover:scale-102"></i></a>
                                        <a class="mx-1 btn btn-danger btn-xs">
                                            <form action="{{ route('admin.depo.delete', $d['id']) }}" method="post" onsubmit="return confirm('Apakah yakin ingin menghapus depo {{ $d['nama'] }} ?')">
                                                @csrf
                                                @method('delete')
