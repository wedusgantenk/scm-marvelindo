                ...
                try {
                    ...
                    data.columns.forEach(function(col) {
                        if (col.title !== "Room Name") {
                            ...
                            // Memastikan "Room Name" adalah kolom pertama
                            columns.unshift({
                                title: col.title,
                                field: col.field,
                    ...
                    $('#tbl_room').bootstrapTable({
                        ...
                        searchPlaceholder: 'Cari berdasarkan Room Name atau Harga', // Placeholder untuk kotak pencarian
                    ...
                    $('#tbl_room').on('click-cell.bs.table', function (e, field, value, row, $el) {
                        if (field === 'room_name' || $(e.target).is('input')) return;  // Mencegah "Room Name" dari diedit
